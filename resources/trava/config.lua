Config = {
    ...
    Distance = { -- All distances in meters
        Draw = 50.0,   -- How close to a plant do you need to be to see it?
    ...
    Items = { -- What items are used?
        Seed = 'seed',     -- Used to plant the weed
        Tend = 'water',             -- Optional item to progress growth cycle
        Product = 'marijuana', -- What item is given when you harvest?
    },
    Scenario = {
    ...
    KupovinaSjeme = {
        vector3(3807.8232421875, 4478.595703125, 6.365396976471),
        vector3(2221.9606933594, 5614.7666015625, 54.90161895752),
        vector3(1522.442993164, 6329.2065429688, 24.60693359375)
    }
}
