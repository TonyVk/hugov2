...
AddEventHandler ('esx_uteknark:test_forest',function(count, randomStage)
    ...
    TriggerEvent("chat:addMessage", {args={'Droga','Target forest size: '..count}})
    local column = math.ceil(math.sqrt(count))
    TriggerEvent("chat:addMessage", {args={'Droga','Column size: '..column}})
    ...
    TriggerEvent("chat:addMessage", {args={'Droga', 'Actual viable locations: '..#forest}})
