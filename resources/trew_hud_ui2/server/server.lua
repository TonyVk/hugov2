...
RegisterServerEvent('kvar:PopraviKvar')
AddEventHandler('kvar:PopraviKvar', function(plate, servis)
    MySQL.Async.execute('UPDATE owned_vehicles SET kvar = 0, servis = @rand WHERE plate = @plate', {['@plate'] = plate, ['@rand'] = servis}, function(affectedRows)
...
ESX.RegisterUsableItem('milk', function(source)
	...
	TriggerClientEvent('status:set', source, 'drunk', 0)
