...
Config.Narudzbe = {
	ls1 = {
		Pos = vector3(-323.56011962891, -132.00401306152, 38.395080566406),
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Motor = vector3(-329.77554321289, -127.69786834717, 38.209609222412),
		OstaviMotor = vector3(-339.2350769043, -140.03305053711, 38.209662628174),
		UzmiMotor = vector3(-329.33801269531, -133.74913024902, 38.209609222412)
	},
	ls2 = {
		Pos = vector3(-320.98831176758, -125.91220092773, 38.721843719482),
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Motor = vector3(-327.08984375, -122.0538482666, 38.20968170166),
		OstaviMotor = vector3(-342.25421142578, -139.90089416504, 38.20968170166),
		UzmiMotor = vector3(-328.87957763672, -125.90351867676, 38.20968170166)
	},
	ls3 = {
		Pos = vector3(-319.42282104492, -119.60282897949, 38.74377822876),
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Motor = vector3(-325.25689697266, -113.64498901367, 38.209677886963),
		OstaviMotor = vector3(-325.96914672852, -110.70240020752, 38.209685516357),
		UzmiMotor = vector3(-325.99945068359, -119.34866333008, 38.209677886963)
	}
}
...
Config.Menus = {
	main = {
		...
		popravak	= "Popravi vozilo",
		zavrsi	    = "Zavrsi narudzbu"
	},
	zavrsi = {
		label = "Zavrsi",
		parent = "main",
