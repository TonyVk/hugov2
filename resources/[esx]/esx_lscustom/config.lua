...
Config.Narudzbe = {
	ls1 = {
		Pos = vector3(-324.27478027344, -133.97250366211, 38.990581512451),
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Motor = vector3(-324.04388427734, -139.87466430664, 38.10968170166),
		OstaviMotor = vector3(-328.10687255859, -139.18695068359, 38.109670257568),
		UzmiMotor = vector3(-322.66125488281, -136.4533996582, 38.10968170166)
	}
}
