...
function SpawnCpove()
	...
	for k,v in pairs(Config.Garages) do
		if v.Brod == nil then
			table.insert(Cpovi, {ID = check, Garaza = v, Tip = 1, Koord = v.SpawnPoint.Pos, Spawnan = false, r = v.SpawnPoint.Color.r, g = v.SpawnPoint.Color.g, b = v.SpawnPoint.Color.b})
		else
			table.insert(Cpovi, {ID = check, Garaza = v, Tip = 3, Koord = v.SpawnMarker.Pos, Spawnan = false, r = v.SpawnMarker.Color.r, g = v.SpawnMarker.Color.g, b = v.SpawnMarker.Color.b})
		end
		table.insert(Cpovi, {ID = check, Garaza = v, Tip = 2, Koord = v.DeletePoint.Pos, Spawnan = false, r = v.DeletePoint.Color.r, g = v.DeletePoint.Color.g, b = v.DeletePoint.Color.b})
		if v.MunicipalPoundPoint ~= nil then
			table.insert(Cpovi, {ID = check, Garaza = v, Tip = 4, Koord = v.MunicipalPoundPoint.Pos, Spawnan = false, r = v.MunicipalPoundPoint.Color.r, g = v.MunicipalPoundPoint.Color.g, b = v.MunicipalPoundPoint.Color.b})
			table.insert(Cpovi, {ID = check, Garaza = v, Tip = 5, Koord = v.SpawnMunicipalPoundPoint.Pos, Spawnan = false, r = v.SpawnMunicipalPoundPoint.Color.r, g = v.SpawnMunicipalPoundPoint.Color.g, b = v.SpawnMunicipalPoundPoint.Color.b})
		end
	end
end
				...
				if Cpovi[i] ~= nil and Cpovi[i].Spawnan then
					if #(coords-Cpovi[i].Koord) < 1.5 then
						...
						elseif Cpovi[i].Tip == 2 then
							...
							currentZone = 'delete'
							break
						elseif Cpovi[i].Tip == 3 then
							isInMarker  = true
							this_Garage = Cpovi[i].Garaza
							currentZone = 'spawn'
							break
						elseif Cpovi[i].Tip == 4 then
							isInMarker  = true
							this_Garage = Cpovi[i].Garaza
							currentZone = 'pound'
							break
