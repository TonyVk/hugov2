...
AddEventHandler('explosionEvent', function(sender, ev)
	if ev.explosionType ~= 0 and ev.explosionType ~= 13 and ev.explosionType ~= 30 and ev.explosionType ~= 12 and ev.explosionType ~= 27 and ev.explosionType ~= 34 and ev.explosionType ~= 22 and ev.explosionType ~= 38 and ev.explosionType ~= 39 and ev.explosionType ~= 61 then
