...
function OpenSaveableMenu(submitCb, cancelCb, restrict, scena)
	TriggerEvent('skinchanger:getSkin', function(skin)
		lastSkin = skin
	end)
...
AddEventHandler('esx_skin:openSaveableMenu', function(submitCb, cancelCb)
	...
	OpenSaveableMenu(submitCb, cancelCb, nil, true)
	Moze = true
end)

RegisterNetEvent('esx_skin:openCmdMenu')
AddEventHandler('esx_skin:openCmdMenu', function(submitCb, cancelCb)
	local characterModel
	characterModel = GetHashKey('mp_m_freemode_01')
