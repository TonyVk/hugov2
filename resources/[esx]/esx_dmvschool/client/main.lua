...
function DrawMissionText(msg, time)
	...
	if msg == _U('stop_for_ped') then
		TaskGoStraightToCoord(Pedara, 226.59735107422, -1343.4515380859, 30.471097946167, 1, 5000)
	end
end
...
function StartTheoryTest()
	...
	TriggerServerEvent('polozi:tuljana', Config.Prices['dmv'])
end
...
function StartDriveTest(type)
	if CurrentTest == nil then
		ESX.Game.SpawnVehicle(Config.VehicleModels[type], Config.Zones.VehicleSpawnPoint.Pos, Config.Zones.VehicleSpawnPoint.Heading, function(vehicle)
			CurrentTest       = 'drive'
